...
router.get('/count-students', isAuthenticated, allowRoles('admin', 'coordinator', 'chairperson', 'faculty'), getStudentCount);
router.get('/search-students', isAuthenticated, allowRoles('admin', 'coordinator', 'chairperson', 'faculty'), searchStudents);
router.get('/get-student-profile/:rollNo', isAuthenticated, allowRoles('admin', 'coordinator', 'chairperson', 'faculty'), getStudentProfile);
router.get('/get-student-details', isAuthenticated, allowRoles('student'), getStudentDetails);
router.post('/filter-students', isAuthenticated, allowRoles('admin', 'coordinator', 'chairperson', 'faculty'), getFilteredStudents);
